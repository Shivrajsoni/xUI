...
const prePath = process.env.VERCEL_PRODUCTION_URL ? `https://${process.env.VEREL_PRODUCTION_URL}` : "https://xoder.vercel.app/";
      ...
      (
        <div className='w-full my-4 border rounded-2xl border-zinc-400 dark:border-zinc-700'>
            <div className='relative w-full h-[1000dvh] overflow-hidden '>
                <iframe title={link} src={`${prePath}/preview/${link}`} className='w-full h-full overflow-y-auto list-none' 
